import { reactive, type Ref, ref, shallowReactive } from 'vue';
...
export const useTableColumn = function (columns: TableColumnPops[], options: TableColumnPops = { dataIndex: '', key: '', align: 'center' }) {

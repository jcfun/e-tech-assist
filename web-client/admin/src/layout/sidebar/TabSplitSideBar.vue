...
<script lang="ts">
  ...
  import { transformSplitTabMenu } from '@/store/modules/perm/utils';
  import { SideTheme, type SplitTab } from '@/store/types/layout';
  export default defineComponent({
    ...
    setup() {
      ...
      onMounted(() => {
        tabs.length = 0;
        tabs.push(...transformSplitTabMenu(permStore.getPermSplitTabs));
        doChangeTab(route);
      });

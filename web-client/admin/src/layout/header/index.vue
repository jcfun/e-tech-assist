<template>
  <div class="vaw-header-layout">
    ...
    <div class="menu-wrapper">
      <ScrollerMenu :routes="permStore.getTopLevelTabs" mode="horizontal" @top-item-click="onTopItemClick" />
    </div>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      function onTopItemClick(key: string) {
        handlePath(permStore.getTopLevelTabs.find(it => it.path === key)?.items || []);
      }
      return {
        permStore,
        appStore,

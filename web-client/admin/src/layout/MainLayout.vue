<template>
  <div
    ...
    :class="[
      ...
      !appStore.isFixedNavBar ? 'main-layout_padding-top__0' : isShowTabbar ? 'main-layout_padding-top__all' : 'main-layout_padding-top__logo',
    ]"
  >
    <section
      :class="[
        appStore.layoutMode == 'ttb' ? 'nav-bar-open-status__ttb' : !appStore.isCollapse ? 'nav-bar-open-status' : 'nav-bar-close-status',
    ...
    >
      <section class="main-section" :class="[appStore.flexMainHeight ? 'flex-height' : 'min-height']">
        <Main />
      </section>
